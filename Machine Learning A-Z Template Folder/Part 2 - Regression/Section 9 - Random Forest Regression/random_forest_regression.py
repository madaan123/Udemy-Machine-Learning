...
'''
Now we are going to use random forest regression technique to predict the results of the salary
Random forest is a extension of the desicion tre regression and n_estimators specifies the number
of random trees in our forests
...
#Predicting the salary using Random forest regression of 6.5 level
